...
const text = {
  en: {
    ...
    male: 'Male',
    female: 'Female',
    numberOfBouts: 'Number of Bouts Played',
  ...
  rw: {
    ...
    male: 'Gabo',
    female: 'Gore',
    numberOfBouts: 'Umubare w’imikino yakinnye',
...
export default function EventRegister() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 pb-28 sm:pb-16">
      <div className="relative overflow-hidden bg-linear-to-br from-slate-950 via-slate-900 to-brand-900 px-4 py-8 text-white sm:py-10">
